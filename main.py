...
rhs_ineq = [-16, 8, 16, 0, 32, 0, 24]
F_ideal = []
for i in range(len(list_f)):
    res1 = optimize.linprog(c=list_f[i], A_ub=lhs_ineq, b_ub=rhs_ineq, method='highs')
...
while True:
    ...
    res1 = optimize.linprog(c=[fi_k_X.coeffs()[0], fi_k_X.coeffs()[1]], A_ub=lhs_ineq, b_ub=rhs_ineq, method= 'highs')
